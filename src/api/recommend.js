import {commonParams,ERR_OK,cb} from './config'
import Vue from 'vue'
export function getRecommend(){
    return Vue.http.jsonp('https://c.y.qq.com/musichall/fcgi-bin/fcg_yqqhomepagerecommend.fcg',{
